...
Usage examples:
    ...
    python playground/client.py --compare qwen2.5-0.5b tinyllama-chat "Write a haiku about GPUs."

    # Run all sample prompts
    python playground/client.py --prompts-file playground/prompts/sample_prompts.json

    # Compare using sample prompts file
...
def run_compare(
    ...
    try:
        ...
        resp_a["_latency_ms"] = (time.perf_counter() - t0) * 1000
        ...
        resp_b["_latency_ms"] = (time.perf_counter() - t0) * 1000
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        help="Compare two models side-by-side on the same prompt(s).",
    )
    p.add_argument(
        "--prompts-file",
        metavar="PATH",
