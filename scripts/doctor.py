#!/usr/bin/env python3
"""Print the GET /v1/doctor readiness report (environment + per-model VRAM fit).

Usage:
    make doctor
    uv run python scripts/doctor.py [--base-url http://localhost:8000]
